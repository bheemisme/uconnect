...
export default function Settings() {
    ...
    const [school,deleteStore] = useStore((state) => [state.school,state.deleteStore], shallow)

    
    const onSignOut = useCallback((e: MouseEvent<HTMLButtonElement>) => {
        e.preventDefault()
        deleteStore()
    ...
    const onDelete = useCallback(async (e: MouseEvent<HTMLButtonElement>) => {
        e.preventDefault()
